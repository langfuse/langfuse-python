...
T = TypeVar("T", bound="LogModelParameters")


@attr.s(auto_attribs=True)
class LogModelParameters:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        log_model_parameters.additional_properties = additional_properties
        return log_model_parameters
