...
from langfuse_utils import langfuse_completion_transformer
...
class OpenAIServingCompletion(OpenAIServing):
    ...
    @observe(
        ...
        capture_output=True,
        as_type="generation",
        transform_to_string=langfuse_completion_transformer,
    )
    async def create_completion(self, request: CompletionRequest, raw_request: Request):
        ...
        langfuse_context.update_current_trace(
            name="create_completion", version="vLLM", release=vllm.__version__
        )
        ...
        # Track final output with Langfuse
        ...
        for final_res in final_res_batch:
            ...
            for output in final_res.outputs:
                ...
                if request.echo and request.max_tokens == 0:
                    ...
                    top_logprobs = (
                        prompt_logprobs + output.logprobs if request.logprobs else None
                    )
