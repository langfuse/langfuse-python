    ...
    def on_chain_end(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            _input = kwargs.get("inputs")

            self.runs[run_id] = self.runs[run_id].end(
                output=outputs, version=self.version, input=_input
            )

            self._update_trace(run_id, parent_run_id, outputs, input=_input)
        except Exception as e:
            self.log.exception(e)
    ...
    def on_chain_error(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            self._update_trace(run_id, parent_run_id, error, input=_input)
