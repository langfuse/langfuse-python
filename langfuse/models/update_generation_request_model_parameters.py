...
T = TypeVar("T", bound="UpdateGenerationRequestModelParameters")


@attr.s(auto_attribs=True)
class UpdateGenerationRequestModelParameters:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        update_generation_request_model_parameters = cls()
        ...
        update_generation_request_model_parameters.additional_properties = additional_properties
        return update_generation_request_model_parameters
