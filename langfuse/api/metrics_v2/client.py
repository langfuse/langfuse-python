...
from .raw_client import AsyncRawMetricsV2Client, RawMetricsV2Client
from .types.metrics_v2response import MetricsV2Response


class MetricsV2Client:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawMetricsV2Client(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawMetricsV2Client:
        """
...
class AsyncMetricsV2Client:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawMetricsV2Client(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawMetricsV2Client:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawMetricsV2Client
        """
        return self._raw_client
    ...
    async def metrics(
        ...
        **scores-numeric / scores-categorical views:**
        ...
        async def main() -> None:
            await client.metrics_v2.metrics(
                query="query",
            )
