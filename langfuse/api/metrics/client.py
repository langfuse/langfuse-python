...
class MetricsClient:
    ...
    def metrics(
        ...
        **SDK namespace mapping:** In SDKs, `client.metrics` always points to the latest supported metrics API. Legacy V1 remains available under `client.legacy.metricsV1`.
