...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CreateEvaluationRuleEvaluatorAssignment": ".types",
    "CreateEvaluationRuleEvaluatorReference": ".types",
    "CreateEvaluationRuleRequest": ".types",
    "CreateEvaluationRuleWithEvaluatorsRequest": ".types",
    "CreateLlmAsJudgeEvaluationRuleRequest": ".types",
    "DeleteEvaluationRuleResponse": ".types",
    "EvaluationRule": ".types",
    "EvaluationRuleBase": ".types",
    "EvaluationRuleEvaluator": ".types",
    "EvaluationRuleEvaluatorAssignment": ".types",
    "EvaluationRuleEvaluatorReference": ".types",
    "EvaluationRuleTimeScope": ".types",
    "EvaluationRules": ".types",
    "LegacyEvaluationObject": ".types",
    "LegacyEvaluationRule": ".types",
    "LegacyEvaluationRuleEvaluatorAssignment": ".types",
    "LegacyEvaluationRuleTarget": ".types",
