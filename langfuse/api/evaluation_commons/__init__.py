...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "EvaluationRuleReadFilter": ".types",
    "EvaluationRuleReadFilterBase": ".types",
    "EvaluationRuleReadFilterWithKey": ".types",
    "EvaluationRuleStringFilterOperator": ".types",
    "EvaluatorOutputDefinition": ".types",
    "EvaluatorOutputDefinitionBase": ".types",
    ...
    "EvaluatorOutputScoreType": ".types",
    "EvaluatorType": ".types",
    "LegacyEvaluationObject": ".types",
    "LegacyPromptVariableMapping": ".types",
    "NullEvaluationRuleFilter": ".types",
    "NumberEvaluationRuleFilter": ".types",
    "NumberObjectEvaluationRuleFilter": ".types",
    "PromptVariableMapping": ".types",
    "PromptVariableMappingInput": ".types",
    "PromptVariableMappingRead": ".types",
    "PromptVariableMappingSource": ".types",
    "PublicEvaluatorBooleanScore": ".types",
    "PublicEvaluatorCategoricalScore": ".types",
    "PublicEvaluatorNumericScore": ".types",
