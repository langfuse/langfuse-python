...
class EvaluatorOutputScoreType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is EvaluatorOutputScoreType.NUMERIC:
            return numeric()
        if self is EvaluatorOutputScoreType.BOOLEAN:
            return boolean()
        if self is EvaluatorOutputScoreType.CATEGORICAL:
            return categorical()
