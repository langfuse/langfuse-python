...
from .raw_client import AsyncRawScoresV2Client, RawScoresV2Client
from .types.get_scores_response import GetScoresResponse


class ScoresV2Client:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawScoresV2Client(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawScoresV2Client:
        """
    ...
    def get_many(
        ...
        **Deprecated.** Use `GET /api/public/v3/scores` instead. This endpoint
        ...
        client.legacy.scores_v2.get_many()
        """
    ...
    def get_by_id(
        ...
        **Deprecated.** Use `GET /api/public/v3/scores` with the `id` filter
        ...
        client.legacy.scores_v2.get_by_id(
            score_id="scoreId",
        )
        """
...
class AsyncScoresV2Client:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawScoresV2Client(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawScoresV2Client:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawScoresV2Client
        """
        return self._raw_client
    ...
    async def get_many(
        ...
        **Deprecated.** Use `GET /api/public/v3/scores` instead. This endpoint
        ...
        async def main() -> None:
            await client.legacy.scores_v2.get_many()
    ...
    async def get_by_id(
        ...
        **Deprecated.** Use `GET /api/public/v3/scores` with the `id` filter
        ...
        async def main() -> None:
            await client.legacy.scores_v2.get_by_id(
                score_id="scoreId",
            )
