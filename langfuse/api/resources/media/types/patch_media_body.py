...
class PatchMediaBody(pydantic_v1.BaseModel):
    ...
    upload_http_error: typing.Optional[str] = pydantic_v1.Field(alias="uploadHttpError", default=None)
    """
    The HTTP error message of the upload
    """

    upload_time_ms: typing.Optional[int] = pydantic_v1.Field(alias="uploadTimeMs", default=None)
    """
