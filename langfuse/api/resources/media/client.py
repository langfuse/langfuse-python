...
class MediaClient:
    ...
    def get(self, media_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetMediaResponse:
        """
        Get a media record
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"api/public/media/{jsonable_encoder(media_id)}", method="GET", request_options=request_options
        )
        try:
    ...
    def patch(
        self, media_id: str, *, request: PatchMediaBody, request_options: typing.Optional[RequestOptions] = None
    ) -> None:
        """
    ...
    def get_upload_url(
        self, *, request: GetMediaUploadUrlRequest, request_options: typing.Optional[RequestOptions] = None
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "api/public/media", method="POST", json=request, request_options=request_options, omit=OMIT
        )
        try:
            if 200 <= _response.status_code < 300:
                return pydantic_v1.parse_obj_as(GetMediaUploadUrlResponse, _response.json())  # type: ignore
            if _response.status_code == 400:
                raise Error(pydantic_v1.parse_obj_as(typing.Any, _response.json()))  # type: ignore
            if _response.status_code == 401:
                raise UnauthorizedError(pydantic_v1.parse_obj_as(typing.Any, _response.json()))  # type: ignore
...
class AsyncMediaClient:
    ...
    async def get(self, media_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetMediaResponse:
        """
        Get a media record
