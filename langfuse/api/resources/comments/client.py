...
class CommentsClient:
    ...
    def create(
        self, *, request: CreateCommentRequest, request_options: typing.Optional[RequestOptions] = None
        ...
        _response = self._client_wrapper.httpx_client.request(
            "api/public/comments", method="POST", json=request, request_options=request_options, omit=OMIT
        )
        try:
    ...
    def get_by_id(self, comment_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Comment:
        """
        Get a comment by id
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/public/comments/{jsonable_encoder(comment_id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
...
class AsyncCommentsClient:
    ...
    async def get_by_id(self, comment_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Comment:
        """
        Get a comment by id
