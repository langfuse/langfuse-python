...
class DatasetItemsClient:
    ...
    def create(
        self, *, request: CreateDatasetItemRequest, request_options: typing.Optional[RequestOptions] = None
    ) -> DatasetItem:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/public/dataset-items"),
    ...
    def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DatasetItem:
        """Get a dataset item
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"api/public/dataset-items/{jsonable_encoder(id)}"
            ),
            params=jsonable_encoder(
                request_options.get("additional_query_parameters") if request_options is not None else None
            ),
...
class AsyncDatasetItemsClient:
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DatasetItem:
        """Get a dataset item
