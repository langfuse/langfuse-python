...
class DatasetRunsClient:
    ...
    def get(self, dataset_run_name: str) -> Dataset:
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment}/", f"api/public/dataset-runs/{dataset_run_name}"),
...
class AsyncDatasetRunsClient:
    ...
    async def get(self, dataset_run_name: str) -> Dataset:
