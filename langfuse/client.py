...
class Langfuse:
    ...
    async def trace(self, body: CreateTrace):
        try:
            ...
            await self.task_manager.add_task(Task(new_id, task, self.future_id))
    ...
    async def async_flush(self):
        try:
            return await self.task_manager.wait_for_completion()
        except Exception as e:
            traceback.print_exception(e)
...
class StatefulClient:
    ...
    async def generation(self, body: CreateGeneration):
        try:
            ...
            await self.task_manager.add_task(Task(generation_id, task, self.future_id))
        except Exception as e:
            traceback.print_exception(e)
    ...
    async def span(self, body: CreateSpan):
        try:
            ...
            await self.task_manager.add_task(Task(span_id, task, self.future_id))
    ...
    async def score(self, body: CreateScore):
        try:
            ...
            await self.task_manager.add_task(Task(score_id, task, self.future_id))
    ...
    async def event(self, body: CreateEvent):
        try:
            ...
            await self.task_manager.add_task(Task(body.id, task, self.future_id))
...
class StatefulGenerationClient(StatefulClient):
    ...
    async def update(self, body: UpdateGeneration):
        try:
            ...
            await self.task_manager.add_task(Task(future_id, task, self.future_id))
