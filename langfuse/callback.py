...
class CallbackHandler(BaseCallbackHandler):
    ...
    def on_chain_start(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on chain start: {run_id}")
    ...
    def on_agent_action(
        ...
        **kwargs: Any,
        ...
        """Run on agent action."""
        try:
            logger.debug(f"on agent action: {run_id}")
    ...
    def on_agent_finish(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on agent finish: {run_id}")
            if run_id not in self.runs:
                raise Exception("run not found")
    ...
    def on_chain_end(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on chain end: {run_id}")
    ...
    def on_chain_error(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on chain error: {run_id}")
    ...
    def on_chat_model_start(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on chat model start: {run_id}")
    ...
    def on_llm_start(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on llm start: {run_id}")
    ...
    def on_tool_start(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on tool start: {run_id}")
    ...
    def on_retriever_start(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on retriever start: {run_id}")
    ...
    def on_retriever_end(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on retriever end: {run_id}")
    ...
    def on_tool_end(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on tool end: {run_id}")
            if run_id is None or run_id not in self.runs:
                raise Exception("run not found")
    ...
    def on_tool_error(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on tool error: {run_id}")
            if run_id is None or run_id not in self.runs:
                raise Exception("run not found")
    ...
    def on_llm_end(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on llm end: {run_id}")
            if run_id not in self.runs:
                raise Exception("run not found")
            else:
    ...
    def on_llm_error(
        ...
        **kwargs: Any,
        ...
        try:
            logger.debug(f"on llm error: {run_id}")
